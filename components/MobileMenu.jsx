...
const MobileMenu = ({ open, setOpen }) => {
  ...
  return (
    <>
      <div
        className={`fixed h-[50vh] top-full right-0 left-0 transition-transform ease-in duration-1000 bg-[rgba(0,0,0,.9)] text-white p-4 border-b border-b-gray-700 ${
          open && "translate-y-[0vh]"
        }`}
      >
        {/* <button onClick={() => setOpen(!open)}>Close</button> */}
        <ul
          className="flex flex-col items-center justify-center h-full text-2xl font-medium gap-3 font-orbitron"
        ...
        >
          ...
          <button
            className="text-lg text-white bg-purple-600 rounded px-4 py-1 font-semibold font-josefin"
